...
if __name__ == '__main__':
    ...
    parser.add_argument('--pocket_path', type=str, default='./data/crossdocked_pocket10/1A1C_MALDO_2_433_0/1m4n_A_rec_1m7y_ppg_lig_tt_min_0_pocket10.pdb')
    ...
    parser.add_argument('--data_path', type=str, default='./data/crossdocked_pocket10')
    parser.add_argument('--split_data_path', type=str, default='./data/split_by_name.pt')
