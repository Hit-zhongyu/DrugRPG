...
class DiffusionTransformer(nn.Module):
    ...
    def forward(self, batch, h, x, edge_feat, time,  ligand_edge_index, ligand_batch, protein_batch, protein_pos_norm,
                linker_mask=None, linker_edge_index=None, linker_edge_feat=None, frag=False):
        ...
        if linker_edge_feat is not None:
            linker_edge_attr = self.ligand_edge_emb(linker_edge_feat)
            edge_time_emb3 = time_emb[ligand_batch[linker_edge_index[0]]]
